...
export default {
  ...
  ORDER_CANCEL_MSG_DELIVERY_TOO_LATE: "Vous serez débité du montant de la commande (%AMOUNT%$)",
  ORDER_CANCEL_MSG_DELIVERY: "Vous ne serez pas débité si vous annulez avant %TIME%",
